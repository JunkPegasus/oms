...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 03. Dez 2018 um 12:09
...
INSERT INTO `changelog` (`id`, `version`, `text`, `type`, `date`, `new`) VALUES
(1, '0.1.0', 'Erste funktionstüchtige Version des Objekt Management Systems wurde implementiert%%', 0, '2018-11-30 12:16:07', 1);
...
(27, 1, 0, 0, '../objects/Gänsbauchfestla Banner/638261/image_0.jpg', 18),
(28, 1, 0, 0, '../objects/Gänsbauchfestla Banner/638261/image_1205209.jpg', 18);
...
(18, 'Banner 2019', 3, 'Gänsbauchfestla Banner', '../objects/Gänsbauchfestla Banner/638261/', 1, 0, 0, 0, 'admin', '2018-12-03 11:49:06', 'admin', '2018-12-03 11:49:06');
...
(3, 'Gänsbauchfestla Banner', 1, 0, 0, '2018-12-03 09:28:35', 'admin', '2018-12-03 09:28:35', 'admin');
...
INSERT INTO `settings` (`id`, `name`, `description`, `isActive`) VALUES
(1, 'Gänsbauchfestla Banner anzeigen', 'Entscheidet ob das Banner auf der Webseite angezeigt werden soll oder nicht.', 0);
...
(1, 'admin', '$2y$10$UWTdPCKtLPN2ecOerw28ku3IMu7g7/vru1DVkRFoCYMI8ABKjgk66', 'Administrator', 'Administrator', 10, 1, 0, '2018-02-10 00:00:00', 'admin', '2018-12-03 12:03:02', 'admin');
